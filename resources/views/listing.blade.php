                            ...
                            @foreach($brt as $m)
                                <ul class="list-unstyled">
                                    <li class="mb-2">
                                        ...
                                        <br>
                                        <a href="{{ url('/berita/' . $m->id_berita . '/' . str_replace([' ', '/', '\\'], '-', $m->judul)) }}" class="text-decoration-none">
...
L.marker([-0.18078, 100.56634]).addTo(map)
    .bindPopup('<b>Nagari Koto Rantang</b><br>Kecamatan Palupuh, Kabupaten Agam<br><a href="https://maps.app.goo.gl/qBC22QPnEJ4ZfWy7A" target="_blank">Buka di Google Maps</a>')
    .openPopup();
