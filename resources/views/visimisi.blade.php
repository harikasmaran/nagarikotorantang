        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4 border-custom">
                ...
                <div class="card-body">
                    ...
                    <li><a href="/galeri" class="text-decoration-none">Galeri</a></li>
                </ul>
                </div>
            </div>
            ...
            <div class="card mb-4 border-custom">
                ...
                <div class="card-body">
                    <!-- Tab Navigation -->
                    <ul class="nav nav-tabs" id="pendudukTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="grafik-tab" data-bs-toggle="tab" 
                                    data-bs-target="#grafik" type="button" role="tab" aria-controls="grafik" aria-selected="true">
                                Grafik
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tabel-tab" data-bs-toggle="tab" 
                                    data-bs-target="#tabel" type="button" role="tab" aria-controls="tabel" aria-selected="false">
                                Tabel
                            </button>
                        </li>
                    </ul>
                    ...
                    <!-- Tab Content -->
                    <div class="tab-content mt-3" id="pendudukTabContent">
                        <!-- Grafik -->
            ...
            <div class="card mb-4 border-custom">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3" id="arsipTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="terkini-tab" data-bs-toggle="tab" 
                                    data-bs-target="#terkini" type="button" role="tab">Terkini</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="populer-tab" data-bs-toggle="tab" 
                                    data-bs-target="#populer" type="button" role="tab">Populer</button>
                        </li>
                    </ul>
                            ...
                            @foreach($brt as $m)
                                <ul class="list-unstyled">
                                    <li class="mb-2">
                                        ...
                                        <br>
                                        <a href="{{ url('/berita/' . $m->id_berita . '/' . str_replace([' ', '/', '\\'], '-', $m->judul)) }}" 
                            ...
                            @foreach($populer as $p)
                                <ul class="list-unstyled">
                                    <li class="mb-2">
                                        ...
                                        <br>
                                        <a href="{{ url('/berita/' . $p->id_berita . '/' . str_replace([' ', '/', '\\'], '-', $p->judul)) }}">
                                            {{ $p->judul }}
                                        </a>
                                    </li>
                                </ul>
